...
import { essentialOils } from "@/data/products";

const EssentialOils = () => {
  const [searchQuery, setSearchQuery] = useState("");

  const filteredProducts = essentialOils.filter((product) => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6">
              Essential <span className="text-primary">Oils</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Discover our premium collection of pure, steam-distilled essential oils sourced from India's finest botanicals. 
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              <p className="text-xl text-muted-foreground">
                No essential oils found matching your search.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              All essential oils available in various bulk quantities with competitive wholesale pricing.
            </p>
